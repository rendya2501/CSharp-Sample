...
namespace NullableDictionary2
{
    ...
    public static class TaxationTypeItemSource
    {
        ...
        /// すべてを含む一覧
        /// </summary>
        public static IList<KeyValuePair<TaxationType?, string>> ValidFlagListHasBlank
        {
            get
            {
                return new List<KeyValuePair<TaxationType?, string>>()
                {
                    new KeyValuePair<TaxationType?, string>(null, "すべて"),
                    new KeyValuePair<TaxationType?, string>(TaxationType.OutsideTax, "外税"),
                    new KeyValuePair<TaxationType?, string>( TaxationType.InsideTax, "内税" ),
                    new KeyValuePair<TaxationType?, string>( TaxationType.TaxFree, "非課税" ),
                };
            }
        }
        /// <summary>
